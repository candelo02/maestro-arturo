  ...
  return (
    <section id="maestro" className="py-20 px-6 bg-[rgba(255,255,255,0.02)] dark:bg-[rgba(0,0,0,0.98)]">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h3 className="text-3xl font-bold text-orange-500 mb-4">Sobre Maestro Valerio</h3>
          <p className="text-gray-300 dark:text-gray-400 mb-4">
            Maestro Valerio es un guía espiritual con años de experiencia en tradiciones ancestrales y prácticas contemporáneas de sanación.
          ...
          <p className="text-gray-300 mb-4">
            Con una presencia serena y una sensibilidad afinada para las energías sutiles, Valerio brinda confianza y respeto. Sus cualidades
        ...
        <div className="rounded-xl overflow-hidden shadow-glow soft-glow border border-gray-800">
          <img src="/images/maestro-valerio.jpg" alt="Maestro Valerio" className="w-full h-72 object-cover" />
        </div>
      </div>
    </section>
  )
